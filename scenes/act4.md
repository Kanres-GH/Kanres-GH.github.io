...
b: Даже несмотря на всё это, мы всё ещё здесь.
...
b: Да, я вижу черту между слышаньем громкого грома, и стоянием в буре с высокой остроконечной шляпой.
...
[Я согласна: поработаем с нашей социальной жизнью.](#act4_alone_skills)
...
h: Или сделать хорошие социальные привычки, как провождение времени с друзьями или регулярные знакомства?
...
[Это разве не *манипуляция?*](#act4_alone_skills_manipulative)
...
h: Кстати... тот мысленный образ с губной помадой... *фу*.
...
h: На социальной арене мы даже не в полулегком весе, мы такие... пушинки.
...
[Что делать, если мы *слишком* исправимся?](#act4_bad_fix_too_much)
...
b: Построение здоровых отношений со своими эмоциями не так-то просто, как нажатие кнопок на экране.
...
a: Т-ты же не против, если я посижу с тобой за ланчем?
...
{{if _.TOP_FEAR=="alone"}}
s: Спрашивать своего возлюбленного можем ли мы составить ему компанию? Ты знаешь, как *убого* мы звучим?!
{{/if}}
...
h2: Просто вспомнила дружеское лицо, вот и всё.
...
b: Я хочу быть сигналом для твоих *психологических* потребностей – твоих потребностей в безопасности, принадлежности, праведности.
